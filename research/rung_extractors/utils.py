...
def extract_function_names_from_code(code: str, filename: Optional[str] = None) -> List[str]:
...
def _extract_code_tokens(code: str, file_path: Optional[str] = None) -> List[str]:
